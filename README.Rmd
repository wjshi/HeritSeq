...
Next, download the [package tarball](https://github.com/KechrisLab/HeritSeq/blob/master/package/HeritSeq_1.0.2.tar.gz) and install the package:

```{r, eval = FALSE}
install.packages("HeritSeq_1.0.2.tar.gz",repos=NULL,type="source")
library("HeritSeq")
```
```{r, echo = FALSE}
